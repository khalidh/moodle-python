...
- `geometrie_seconde_short.yaml` : prompt metier raccourci pour experimenter rapidement.
- `formation_minimale.json` : exemple minimal de formation valide selon le contrat actuel.
